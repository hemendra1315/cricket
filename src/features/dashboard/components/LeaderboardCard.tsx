            ...
            {entries.map((entry, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="text-fg-muted flex h-8 w-8 items-center justify-center rounded-full bg-surface-muted text-sm font-medium">
                    {index + 1}
                  </span>
                  <div>
                    <p className="text-fg font-medium">{entry.name}</p>
                    {secondaryLabel && entry.secondaryValue && (
                      <p className="text-fg-muted text-xs">{secondaryLabel}: {entry.secondaryValue}</p>
                    )}
                  </div>
                </div>
